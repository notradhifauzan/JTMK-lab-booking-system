    ...
    <main class="p-2">
        ...
        <div class="row g-5">
            ...
            <div class="col-md-7 col-lg-8">
                <form action="<?php echo URLROOT; ?>/staffs/labBooking/<?php echo $data['lab']->lab_id; ?>" class="needs-validation" method="POST">
                    <input type="hidden" name="staffic" value="<?php echo $data['staff']->staff_ic; ?>">
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <label for="name" class="form-label">Name</label>
                            <input disabled type="text" class="form-control" name="name" placeholder="" value="<?php echo $data['staff']->staff_name; ?>" required>
                            <div class="invalid-feedback">
                            </div>
                        </div>

                        <div class="col-sm-6">
                            <label for="id" class="form-label">Staff ID/IC</label>
                            <input disabled type="text" class="form-control" name="matric" placeholder="" value="<?php echo $data['staff']->staff_ic; ?>" required>
                            <div class="invalid-feedback">
                            </div>
                        </div>
