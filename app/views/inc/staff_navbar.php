            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start bg-light">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo URLROOT; ?>/staffs/myBookings">My bookings</a></li>
                            <li><a class="dropdown-item" href="<?php echo URLROOT; ?>/staffs/allLabs">View all labs</a></li>
                        </ul>
                    </li>
                ...
                <div class="dropdown text-end">
                    <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="<?php echo URLROOT; ?>/img/logos/staff_icon.png" alt="mdo" width="32" height="32" class="rounded-circle">
                    </a>
                    <ul class="dropdown-menu text-small">
                        <li><a class="dropdown-item" href="<?php echo URLROOT; ?>/staffs/logout">Sign out</a></li>
                    </ul>
                </div>
            </div>
        </div>
