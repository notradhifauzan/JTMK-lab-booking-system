...
<main class="bg-light rounded-2">
    <div class="mt-4 row g-4 bg-light rounded col-12 col-lg-8 mx-auto">
        ...
        <div class="col-md-7 col-lg-8">
            <button onclick="location.href='<?php echo URLROOT; ?>/students/allLabs'" class="btn btn-outline-secondary"><i class="fa-solid fa-arrow-left"></i> Return</button>
            ...
            <button onclick="location.href='<?php echo URLROOT; ?>/students/labBooking/<?php echo $data['lab']->lab_id; ?>'" class="w-100 btn btn-primary btn-sm mb-3" type="button"><i class="fa-regular fa-pen-to-square"></i> Book this lab</button>
        </div>
    </div>
</main>
<script>
