                            ...
                            <div class="card-body text-center">
                                ...
                                <center>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <button onclick="location.href='<?php echo URLROOT; ?>/students/viewLabDetails/<?php echo $labs->lab_id; ?>'" type="button" class="btn btn-sm btn-outline-secondary">View facilities</button>
                                            <button onclick="location.href='<?php echo URLROOT; ?>/students/labBooking/<?php echo $labs->lab_id; ?>'" type="button" class="btn btn-sm btn-outline-secondary">Book this lab</button>
                                        </div>
                                    </div>
                                </center>
                            </div>
